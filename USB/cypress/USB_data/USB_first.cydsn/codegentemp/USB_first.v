...
module USBFS_v3_20_0 (
	...
	cy_psoc3_pins_v1_10
		#(.id("b44fecbc-d71f-4a11-83a8-b9861ce38132/8b77a6c4-10a0-4390-971c-672353e2a49c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b44fecbc-d71f-4a11-83a8-b9861ce38132/618a72fc-5ddd-4df5-958f-a3d55102db42"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__SW2_2_net;
	wire [0:0] tmpIO_0__SW2_2_net;
	wire [0:0] tmpINTERRUPT_0__SW2_2_net;
	electrical [0:0] tmpSIOVREF__SW2_2_net;
	...
	cy_psoc3_pins_v1_10
		...
		SW2_2
		 (.oe(tmpOE__SW2_2_net),
		  .y({1'b0}),
		  .fb({Net_3}),
		  .io({tmpIO_0__SW2_2_net[0:0]}),
		  .siovref(tmpSIOVREF__SW2_2_net),
		  .interrupt({tmpINTERRUPT_0__SW2_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SW2_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
